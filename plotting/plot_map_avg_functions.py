...
def plot_contour_map_avg(var: xr.DataArray,
  ...
  cases: :class:'list' - Optional, default = ['']
         List of strings containing the name of case(s) that will be plotted. These strings will be 
         displayed in the title of each map plot.
  ...
  reglw: :class:'float' - Optional, default = 1.
         Width of line marking region boundary. 
