...
def print_watertag_values(precip: xr.DataArray, d18Op: xr.DataArray,
  ...
  lat, lon
   class: 'xarray.DataArray', latitude and longitude coordinate array
  ...
  season
   class: 'string', text string of season being shown on plot
...
def monthly_watertag_values_to_excel(CASES: str, cases: str, tagnames: list,tagcodes: list, 
                                     begi: str = 'beg', endi: str = 'end',
                                     slat: float = None, nlat: float = None,   
                                     wlon: float = None, elon: float = None,
  ...
  folderpath:  class 'string', String of the path to the folder in which the output file will be placed. 
                               Default = ''
  reg_name: class 'string', Name of region for which water tagging results are calculated, added to output file.
                            Default = ''
  filesuf:  class 'string', Suffix of output file. Default = '.xlsx'
  ---------------------------------------------------------------------------------------------------------------
  ...
  endi = len(ds.time) if endi == 'end' else endi  
